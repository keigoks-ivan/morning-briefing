...
- **產業發展追蹤 `industry_developments`（2026-09-09 新增）**：素材充足時目標 10–14 條，至少 5 個產業、每產業最多 2 條。只收會改變未來 6–18 個月供需、成本、技術路線、競爭格局或資本支出的事件；每條含 `development`、`value_chain`、`why_it_matters`，並與核心要聞及其他新聞區塊去重。渲染在 news 頁與 email 的核心要聞之後。
