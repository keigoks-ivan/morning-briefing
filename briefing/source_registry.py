...
SOURCE_REGISTRY = {
    ...
    "axios": _source("Axios", [], ["axios.com"], "B", "通訊社／財經", ["macro", "geopolitics", "ai", "startup"]),
    ...
    "techcrunch": _source("TechCrunch", ["TechCrunch Venture", "TechCrunch Startups"], ["techcrunch.com"], "B", "科技", ["ai", "startup", "enterprise_ai"]),
    "the_information": _source("The Information", [], ["theinformation.com"], "B", "科技", ["ai", "enterprise_ai", "startup", "longform"]),
    "wired": _source("Wired", ["Wired 商業科技", "Wired 科學"], ["wired.com"], "B", "科技", ["ai", "startup", "frontier", "science", "longform"]),
    "ars_technica": _source("Ars Technica", ["Ars Science"], ["arstechnica.com"], "B", "科技", ["ai", "frontier", "science", "longform"]),
    "mit_tech_review": _source("MIT Technology Review", ["MIT Tech Review"], ["technologyreview.com"], "B", "科技", ["ai", "frontier", "science", "longform"]),
    "crunchbase": _source("Crunchbase", ["Crunchbase News"], ["crunchbase.com"], "B", "科技", ["startup"]),
    "sifted": _source("Sifted", [], ["sifted.eu"], "B", "科技", ["startup", "regional_europe"]),
    "tech_in_asia": _source("Tech in Asia", ["Tech in Asia (GN)"], ["techinasia.com"], "B", "科技", ["startup", "regional_asia"]),
    "ieee_spectrum": _source("IEEE Spectrum", ["IEEE Robotics"], ["spectrum.ieee.org"], "B", "前緣科技", ["frontier", "science", "longform"]),
    "quanta": _source("Quanta Magazine", [], ["quantamagazine.org"], "B", "前緣科技", ["frontier", "science", "longform"]),
    "new_scientist": _source("New Scientist", [], ["newscientist.com"], "B", "前緣科技", ["frontier", "science"]),
    "spacenews": _source("SpaceNews", [], ["spacenews.com"], "B", "前緣科技", ["frontier"]),
    "quantum_insider": _source("The Quantum Insider", [], ["thequantuminsider.com"], "B", "前緣科技", ["frontier"]),
    ...
    "nature": _source("Nature", ["Nature 新聞"], ["nature.com"], "A", "醫療／生技", ["healthcare_ai", "science", "frontier"]),
    "science": _source("Science", ["Science 新聞"], ["science.org"], "A", "醫療／生技", ["healthcare_ai", "science", "frontier"]),
